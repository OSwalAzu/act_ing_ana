...
const languageStrings = {
    en: {
        translation: {
            WELCOME_MESSAGE: 'Welcome to the unit converter. You can ask me to convert length units, for example: convert 5 feet to inches. What would you like to convert?',
    ...
    es: {
        translation: {
            WELCOME_MESSAGE: 'Bienvenido al convertidor de unidades de Oswaldo...Puedes pedirme que convierta unidades de longitud, por ejemplo: convierte 5000 metros a kilometros. ¿Cómo puedo ayudarte? ¿Qué te gustaría convertir?',
            HELP_MESSAGE: 'Puedes pedirme que convierta unidades de longitud, por ejemplo: convierte 5000 metros a kilometros. ¿Cómo puedo ayudarte?',
